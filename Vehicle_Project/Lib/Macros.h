 ...
 * File Name: Macros.h
 *
 * Description: Macros fot Bit and Block operations
 *
...
#define INSERT_BLOCK(REG, BLOCK, VALUE) ((REG) = ((REG) & (~(0x03 << ((BLOCK)*2) )) )| ((VALUE) << ((BLOCK)*2)))
...
#define READ_BLOCK(REG, BLOCK)          (( (REG) >> ((BLOCK)*2) ) & 0x03)
